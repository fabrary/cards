...
Draw a card.`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/WTR_82.width-450.png",
    keywords: [],
...
**Combo** - *If Whelming Gustwave was the last attack this combat chain, Mugenshi: RELEASE gains +1{p}, **go again**, and “If this hits, search your deck for any number of cards named Lord of Wind, reveal them, put them into your hand, then shuffle your deck.”*`,
    ...
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/WTR_92.width-450.png",
    keywords: [],
    name: "Flic Flak",
    rarity: Rarity.Rare,
    sets: [Release.WelcomeToRathe],
    ...
    functionalText: `If the next card you defend with this turn is a card with **combo**, it gains +2{d}.`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/WTR_93.width-450.png",
    keywords: [],
    name: "Flic Flak",
    rarity: Rarity.Rare,
    sets: [Release.WelcomeToRathe],
    ...
    functionalText: `If the next card you defend with this turn is a card with **combo**, it gains +2{d}.`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/WTR_94.width-450.png",
    keywords: [],
    name: "Flic Flak",
    rarity: Rarity.Rare,
    sets: [Release.WelcomeToRathe],
