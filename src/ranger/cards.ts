...
**Reload** *(If you have no cards in your arsenal, you may put a card from your hand face down into your arsenal.)*`,
    ...
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/ARC48.width-450.png",
    keywords: [Keyword.Reload],
    name: "Take Cover",
    rarity: Rarity.Rare,
    sets: [Release.ArcaneRising],
    ...
    functionalText: `**Reload** *(If you have no cards in your arsenal, you may put a card from your hand face down into your arsenal.)*`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/ARC49.width-450.png",
    keywords: [Keyword.Reload],
    name: "Take Cover",
    rarity: Rarity.Rare,
    sets: [Release.ArcaneRising],
    ...
    functionalText: `**Reload** *(If you have no cards in your arsenal, you may put a card from your hand face down into your arsenal.)*`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/ARC50.width-450.png",
    keywords: [Keyword.Reload],
    name: "Take Cover",
    rarity: Rarity.Rare,
    sets: [Release.ArcaneRising],
...
The next time your hero would be dealt damage this turn, prevent it.`,
    ...
    functionalText: `*(Traps can only be played from arsenal.)*

Hit effects don't trigger this chain link unless the attacking hero pays {r}. *(The attacking hero chooses whether to pay {r} as Pitfall Trap resolves.)*`,
...
Deal 2 damage to the attacking hero unless they pay {r}.`,
    imageUrl: "https://storage.googleapis.com/fabmaster/media/images/CRU127.width-450.png",
    keywords: [],
    name: "Pitfall Trap",
    rarity: Rarity.Rare,
    sets: [Release.CrucibleOfWar],
...
Target attack gets -2{p} unless the attacking hero pays {r}. *(The attacking hero chooses whether to pay {r} as Rock Slide Trap resolves.)*`,
