  ...
  const cards1: Card[] = [{
    ...
    rarity: Rarity.SuperRare,
    setIdentifiers: ["GEM088","SUP021"],
    sets: [Release.GEM,Release.SuperSlam],
    specialImage: "SUP021",
    ...
    rarity: Rarity.Common,
    setIdentifiers: ["APS011","LGS435","SUP195"],
...
When this is pitched, defense reaction cards cost opponents an additional {r} to play this turn.`,
    ...
    defaultImage: "SUP259",
    legalFormats: [Format.Blitz,Format.Clash,Format.ClassicConstructed,Format.LivingLegend,Format.Open,Format.SilverAge,Format.UltimatePitFight],
...
If you've been booed this turn, this card's base {p} is doubled.`,
    ...
    classes: [Class.Warrior],
    defaultImage: "SUP252",
    legalFormats: [Format.Blitz,Format.Clash,Format.ClassicConstructed,Format.LivingLegend,Format.Open,Format.UltimatePitFight],
...
At the start of your turn, destroy this.`,
    ...
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["FAB093","SIY019","SUP229","UPR205"],
    sets: [Release.IyslanderSilverAgeDeck,Release.Promos,Release.SuperSlam,Release.Uprising],
    specialImage: "SUP229",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Generic Action - Attack",
    ...
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["GEM101","SKA011","SUP143"],
    sets: [Release.GEM,Release.KayoSilverAgeDeck,Release.SuperSlam],
    specialImage: "SUP143",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Brute Action - Attack",
    ...
    rarities: [Rarity.Common],
    rarity: Rarity.Common,
    setIdentifiers: ["ARR019","SUP144"],
    sets: [Release.ArmoryDeckRhinar,Release.SuperSlam],
    specialImage: "SUP144",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Brute Action - Attack",
    ...
    rarities: [Rarity.Common],
    rarity: Rarity.Common,
    setIdentifiers: ["SKA027","SUP145"],
    sets: [Release.KayoSilverAgeDeck,Release.SuperSlam],
    specialImage: "SUP145",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Brute Action - Attack",
...
- If you control an attack with 6 or more {p}, deal 2 damage to target hero unless they discard a card.`,
    ...
    printings: [{
      ...
      print: "SUP055-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653947",
            url: "https://www.tcgplayer.com/product/653947?Language=English&Printing=Rainbow+Foil"
          },
      
    },],
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["LGS434","SUP055"],
    sets: [Release.Promos,Release.SuperSlam],
    specialImage: "SUP055",
    subtypes: [Subtype.Aura,Subtype.NonAttack],
    types: [Type.Action],
...
At the beginning of your end phase, destroy this.`,
    ...
    rarity: Rarity.Basic,
    setIdentifiers: ["APS031","FAB394","SUP239"],
    sets: [Release.ArmoryDeckPleiades,Release.Promos,Release.SuperSlam],
...
**Tower** - If this has 13 or more {p}, it gets "When this hits a hero, destroy all auras they control."`,
    ...
    printings: [{
      ...
      print: "SUP061-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653950",
            url: "https://www.tcgplayer.com/product/653950?Language=English&Printing=Rainbow+Foil"
          },
...
When this enters the arena, target defending action card gets +1{d} this chain link.`,
    ...
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["APS012","LGS437","SUP201"],
    sets: [Release.ArmoryDeckPleiades,Release.Promos,Release.SuperSlam],
    specialImage: "SUP201",
    subtypes: [Subtype.Aura],
    types: [Type.Instant],
...
When this leaves the arena, your next attack this turn gets +4{p}.`,
    ...
    rarities: [Rarity.Common],
    rarity: Rarity.Common,
    setIdentifiers: ["APS023","SBR033","SUP203"],
    sets: [Release.ArmoryDeckPleiades,Release.BravoSilverAgeDeck,Release.SuperSlam],
    specialImage: "SUP203",
    subtypes: [Subtype.Aura],
    types: [Type.Instant],
    typeText: "Guardian Instant - Aura",
...
**Blade Break**`,
    ...
    printings: [{
      ...
      print: "SUP056-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653948",
            url: "https://www.tcgplayer.com/product/653948?Language=English&Printing=Rainbow+Foil"
          },
...
**Go again**`,
    ...
    printings: [{
      ...
      print: "SUP057-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "652749",
            url: "https://www.tcgplayer.com/product/652749?Language=English&Printing=Rainbow+Foil"
          },
      
    },],
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["GEM091","SUP057"],
    sets: [Release.GEM,Release.SuperSlam],
    specialImage: "SUP057",
    subtypes: [Subtype.NonAttack],
    types: [Type.Action],
...
**Go again**`,
    ...
    printings: [{
      ...
      print: "SUP058-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "652750",
            url: "https://www.tcgplayer.com/product/652750?Language=English&Printing=Rainbow+Foil"
          },
...
**Go again**`,
    ...
    printings: [{
      ...
      print: "SUP059-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "652751",
            url: "https://www.tcgplayer.com/product/652751?Language=English&Printing=Rainbow+Foil"
          },
...
**Blade Break**`,
    ...
    printings: [{
      ...
      print: "SUP060-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653949",
            url: "https://www.tcgplayer.com/product/653949?Language=English&Printing=Rainbow+Foil"
          },
      
    },],
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["GEM092","SUP060"],
    sets: [Release.GEM,Release.SuperSlam],
    specialImage: "SUP060",
    subtypes: [Subtype.NonAttack],
    types: [Type.Action],
...
**Instant** - Discard this and an Earth card: Prevent the next 6 arcane damage target source would deal this turn.`,
    ...
    rarities: [Rarity.Rare],
    rarity: Rarity.Rare,
    setIdentifiers: ["SEN011","SIY011","SUP223"],
    sets: [Release.EnigmaSilverAgeDeck,Release.IyslanderSilverAgeDeck,Release.SuperSlam],
    specialImage: "SUP223",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Generic Action - Attack",
...
When this hits a Runeblade or Wizard hero, you may destroy an aura they control.`,
    ...
    rarities: [Rarity.Basic,Rarity.Promo,Rarity.Token],
    rarity: Rarity.Basic,
    setIdentifiers: ["AKO028","ARR030","BET028","FAB205","FAB280","HVY241","KYO028","LGS230","RHI028","SKA035","SUP240","TCC105","TER028","VIC028"],
    sets: [Release.FirstStrikeTerra,Release.ArmoryDeckKayo,Release.ArmoryDeckRhinar,Release.BetsyBlitzDeck,Release.HeavyHitters,Release.KayoBlitzDeck,Release.KayoSilverAgeDeck,Release.Promos,Release.RhinarBlitzDeck,Release.RoundTheTable,Release.SuperSlam,Release.VictorBlitzDeck],
    specialImage: "undefined",
    subtypes: [Subtype.Aura],
    types: [Type.Token],
    typeText: "Generic Token - Aura",
...
**Tower** - If this has 13 or more {p}, it gets "When this hits a hero, cards they own lose and can't get go again during their next action phase."`,
    ...
    printings: [{
      ...
      print: "SUP062-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653951",
            url: "https://www.tcgplayer.com/product/653951?Language=English&Printing=Rainbow+Foil"
          },
...
**Decompose** - When this attacks, you may banish 2 Earth cards and an action card from your graveyard. If you do, each hero puts a card from their arsenal on the bottom of their deck.`,
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654064",
            url: "https://www.tcgplayer.com/product/654064?Language=English&Printing=Normal"
          },
      ...
      print: "SUP236-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654064",
            url: "https://www.tcgplayer.com/product/654064?Language=English&Printing=Rainbow+Foil"
          },
...
**Go again**`,
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654065",
            url: "https://www.tcgplayer.com/product/654065?Language=English&Printing=Normal"
          },
      ...
      print: "SUP237-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654065",
            url: "https://www.tcgplayer.com/product/654065?Language=English&Printing=Rainbow+Foil"
          },
...
**Go again**`,
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654066",
            url: "https://www.tcgplayer.com/product/654066?Language=English&Printing=Normal"
          },
      ...
      print: "SUP238-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654066",
            url: "https://www.tcgplayer.com/product/654066?Language=English&Printing=Rainbow+Foil"
          },
...
**Go again**`,
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654061",
            url: "https://www.tcgplayer.com/product/654061?Language=English&Printing=Normal"
          },
      ...
      print: "SUP233-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654061",
            url: "https://www.tcgplayer.com/product/654061?Language=English&Printing=Rainbow+Foil"
          },
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654062",
            url: "https://www.tcgplayer.com/product/654062?Language=English&Printing=Normal"
          },
      ...
      print: "SUP234-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654062",
            url: "https://www.tcgplayer.com/product/654062?Language=English&Printing=Rainbow+Foil"
          },
    ...
    printings: [{
      ...
      tcgplayer: {
            productId: "654063",
            url: "https://www.tcgplayer.com/product/654063?Language=English&Printing=Normal"
          },
      ...
      print: "SUP235-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "654063",
            url: "https://www.tcgplayer.com/product/654063?Language=English&Printing=Rainbow+Foil"
          },
...
**Blade Break**`,
    ...
    rarities: [Rarity.Rare],
    rarity: Rarity.Rare,
    setIdentifiers: ["ARR014","SKA018","SUP135"],
    sets: [Release.ArmoryDeckRhinar,Release.KayoSilverAgeDeck,Release.SuperSlam],
    specialImage: "SUP135",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Brute Action - Attack",
...
If this is played at chain link 3 or higher, this gets **go again**.`,
    ...
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["APS013","LGS440","SUP204"],
    sets: [Release.ArmoryDeckPleiades,Release.Promos,Release.SuperSlam],
    specialImage: "SUP204",
    subtypes: [Subtype.Aura],
    types: [Type.Instant],
...
When this leaves the arena, your next attack this turn gets +2{p}.`,
    ...
    rarities: [Rarity.Common],
    rarity: Rarity.Common,
    setIdentifiers: ["APS026","SBR034","SUP207"],
    sets: [Release.ArmoryDeckPleiades,Release.BravoSilverAgeDeck,Release.SuperSlam],
...
**Blade Break**`,
    ...
    rarities: [Rarity.Basic,Rarity.Promo,Rarity.Token],
    rarity: Rarity.Basic,
    setIdentifiers: ["APS032","FAB395","SUP241"],
    sets: [Release.ArmoryDeckPleiades,Release.Promos,Release.SuperSlam],
    specialImage: "undefined",
    subtypes: [Subtype.Aura],
    types: [Type.Token],
...
When this hits a Revered hero, **the crowd boos** you.`,
    ...
    rarities: [Rarity.Promo,Rarity.SuperRare],
    rarity: Rarity.SuperRare,
    setIdentifiers: ["APS030","GEM086","SUP015"],
    sets: [Release.ArmoryDeckPleiades,Release.GEM,Release.SuperSlam],
    specialImage: "SUP015",
    subtypes: [],
    types: [Type.Block],
...
If this is defended by 3 or more cards, it gets **go again**.`,
    ...
    rarities: [Rarity.Promo,Rarity.SuperRare],
    rarity: Rarity.SuperRare,
    setIdentifiers: ["APS028","LGS441","SUP014"],
    sets: [Release.ArmoryDeckPleiades,Release.Promos,Release.SuperSlam],
    specialImage: "SUP014",
    subtypes: [Subtype.Aura],
    types: [Type.Instant],
...
When this hits a hero, create a Confidence and a Toughness token.`,
    ...
    rarities: [Rarity.Basic,Rarity.Promo,Rarity.Token],
    rarity: Rarity.Basic,
    setIdentifiers: ["BET029","FAB206","FAB288","HVY242","KSI029","KYO029","LGS230","OLA029","SBR036","SDO036","SKA036","SUP242","TCC107","VIC029"],
    sets: [Release.BetsyBlitzDeck,Release.BravoSilverAgeDeck,Release.DorintheaSilverAgeDeck,Release.HeavyHitters,Release.KassaiBlitzDeck,Release.KayoBlitzDeck,Release.KayoSilverAgeDeck,Release.OlympiaBlitzDeck,Release.Promos,Release.RoundTheTable,Release.SuperSlam,Release.VictorBlitzDeck],
    specialImage: "undefined",
    subtypes: [Subtype.Aura],
    types: [Type.Token],
    typeText: "Generic Token - Aura",
...
When this leaves the arena, you may destroy an aura permanent that a Guardian hero controls.`,
    ...
    printings: [{
      ...
      print: "SUP052-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653944",
            url: "https://www.tcgplayer.com/product/653944?Language=English&Printing=Rainbow+Foil"
          },
    ...
    printings: [{
      ...
      print: "SUP053-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653945",
            url: "https://www.tcgplayer.com/product/653945?Language=English&Printing=Rainbow+Foil"
          },
    ...
    printings: [{
      ...
      print: "SUP054-Rainbow",
      rarity: Rarity.Common,
      set: Release.SuperSlam,
      tcgplayer: {
            productId: "653946",
            url: "https://www.tcgplayer.com/product/653946?Language=English&Printing=Rainbow+Foil"
          },
