...
**Watery Grave**`,
    ...
    rarities: [Rarity.Common,Rarity.Promo],
    rarity: Rarity.Common,
    setIdentifiers: ["1HP396","FAB015","IRA009","KAT015","KSU017","SEA218","UPR209","WTR191"],
    sets: [Release.HighSeas,Release.HistoryPack1,Release.IraWelcomeDeck,Release.KatsuBlitzDeck,Release.KatsuHeroDeck,Release.Promos,Release.Uprising,Release.WelcomeToRathe],
    specialImage: "SEA218",
    subtypes: [Subtype.Attack],
    types: [Type.Action],
    typeText: "Generic Action - Attack",
