...
When this hits a Runeblade or Wizard hero, you may destroy an aura they control.`,
    ...
    rarities: [Rarity.Basic,Rarity.Promo,Rarity.Token],
    rarity: Rarity.Basic,
    setIdentifiers: ["AKO028","ARR030","BET028","FAB205","FAB280","HVY241","KYO028","LGS230","RHI028","SUP240","TCC105","TER028","VIC028"],
    sets: [Release.FirstStrikeTerra,Release.ArmoryDeckKayo,Release.ArmoryDeckRhinar,Release.BetsyBlitzDeck,Release.HeavyHitters,Release.KayoBlitzDeck,Release.Promos,Release.RhinarBlitzDeck,Release.RoundTheTable,Release.SuperSlam,Release.VictorBlitzDeck],
    specialImage: "undefined",
    subtypes: [Subtype.Aura],
    types: [Type.Token],
    typeText: "Generic Token - Aura",
...
When this hits a hero, create a Confidence and a Toughness token.`,
    ...
    rarities: [Rarity.Basic,Rarity.Promo,Rarity.Token],
    rarity: Rarity.Basic,
    setIdentifiers: ["BET029","FAB206","FAB288","HVY242","KSI029","KYO029","LGS230","OLA029","SDO036","SUP242","TCC107","VIC029"],
    sets: [Release.BetsyBlitzDeck,Release.DorintheaSilverAgeDeck,Release.HeavyHitters,Release.KassaiBlitzDeck,Release.KayoBlitzDeck,Release.OlympiaBlitzDeck,Release.Promos,Release.RoundTheTable,Release.SuperSlam,Release.VictorBlitzDeck],
    specialImage: "undefined",
    subtypes: [Subtype.Aura],
    types: [Type.Token],
    typeText: "Generic Token - Aura",
