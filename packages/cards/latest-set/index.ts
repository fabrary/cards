  ...
  const cards1: Card[] = [{
    ...
    defaultImage: "SUP195",
    legalFormats: [Format.Blitz,Format.Clash,Format.ClassicConstructed,Format.Commoner,Format.Draft,Format.LivingLegend,Format.Open,Format.Sealed,Format.SilverAge,Format.UltimatePitFight],
...
When this is pitched, defense reaction cards cost opponents an additional {r} to play this turn.`,
    ...
    defaultImage: "SUP259",
    legalFormats: [Format.Blitz,Format.Clash,Format.ClassicConstructed,Format.Commoner,Format.LivingLegend,Format.Open,Format.SilverAge,Format.UltimatePitFight],
...
If you've been cheered this turn, this gets **go again**.`,
    ...
    classes: [Class.Brute],
    defaultImage: "SUP064",
    legalFormats: [Format.Blitz,Format.Clash,Format.Commoner,Format.Draft,Format.Open,Format.Sealed,Format.SilverAge,Format.UltimatePitFight],
    legalHeroes: [Hero.RKO],
...
**Go again**`,
    ...
    classes: [Class.Brute],
    defaultImage: "SUP164",
    legalFormats: [Format.Blitz,Format.Clash,Format.ClassicConstructed,Format.Commoner,Format.Draft,Format.LivingLegend,Format.Open,Format.Sealed,Format.UltimatePitFight],
    legalHeroes: [Hero.Brutus,Hero.Kayo,Hero.Levia,Hero.RKO,Hero.Rhinar,Hero.Tuffnut],
